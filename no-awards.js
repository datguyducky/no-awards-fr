...
const callback = (mutationsList, observer) => {
	...
	const NEW_AWARDS_BAR = document.getElementsByClassName('_1wgnb6w6OJogtEV2N4B3lD');
	for(let i=0; i<NEW_AWARDS_BAR.length; i++) {
		NEW_AWARDS_BAR[i].style.display = 'none';
	}

	// hide awards on cross-posted posts
	const CROSS_POST_NEW_AWARDS_BAR = document.getElementsByClassName('_3XoW0oYd5806XiOr24gGdb');
